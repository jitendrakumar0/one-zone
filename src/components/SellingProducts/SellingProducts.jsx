...
const SellingProducts = () => {
    return (
        <>
        <div class="px-5 md:px-10 py-5 sm:py-8 lg:py-10 bg-[#F5F5F7]">
            <div class="flex justify-between items-center w-full mb-5">
                <div class="md:text-black md:text-3xl font-bold text-2xl">Best
                    Selling Products</div>
                <div class="text-md text-nowrap cursor-pointer text-[#09757A]">
                    View All
            ...
            <div class="flex flex-wrap md:flex-nowrap items-stretch gap-5">
                ...
                <div class="md:w-1/2 lg:w-2/3 w-full relative">
                    
                    <div class="flex-none hidden lg:flex">
                        <div class="swiper-button-next absolute top-[50%] translate-y-[-50%] z-50 cursor-pointer sellingNext after:content-[*] md:size-10 size-8 transition-all duration-300 bg-white border border-black text-white rounded-full right-[-20px] md:p-2 p-1">
                            <div class="">
                        ...
                        <div class="swiper-button-prev translate-y-[-50%] z-50 sellingPrev absolute after:content-[*] md:size-10 size-8 transition-all duration-300 bg-white border border-black text-white rounded-full top-[50%] left-[-15px] md:p-2 p-1">
                    ...
                    <Swiper
                        ...
                        className="mySwiper1"
                    >
                        <SwiperSlide className='h-auto' style={{height: 'auto'}}>
                            <div class="group relative rounded-xl bg-white overflow-hidden cursor-pointer h-full">
                                    <div class="relative overflow-hidden">
                                    <div className="m-auto aspect-[1/1] p-3 lg:p-5">
                                        <img className="w-full h-full m-auto object-contain" src={'https://m.media-amazon.com/images/I/61+r3+JstZL.jpg'} alt />
                                    </div>
                                    ...
                                    <div class="bg-white p-3 flex justify-start flex-col items-start">
                                        <div class="text-lg font-medium mb-2">Newest Flagship HP 14</div>
                                        <div className="">
                        ...
                        <SwiperSlide className='h-auto' style={{height: 'auto'}}>
                            <div class="group relative rounded-xl bg-white overflow-hidden cursor-pointer h-full">
                                    <div class="relative overflow-hidden">
                                    <div className="m-auto aspect-[1/1] p-3 lg:p-5">
                                        <img className="w-full h-full m-auto object-contain" src={productImg} alt />
                                    </div>
                                        <div class="flex justify-center items-center absolute py-3 bg-[#09757A] bottom-0 w-full translate-y-48 duration-300 hover:bg-black group-hover:translate-y-0">
                                        <div>
                                            <svg
