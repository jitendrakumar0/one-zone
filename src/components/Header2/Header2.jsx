        ...
        <div className="max-w-screen-xl mx-auto p-4 flex flex-wrap items-center justify-between">
          ...
          <div className="flex md:order-2  md:space-x-0 items-center md:gap-3 gap-1">
            ...
            {/* {!auth ? ( */}
              <Link
                to="/signup"
                className="text-black text-[0.65rem] md:h-[40px] h-[32px] bg-theme1 border-2 border-theme1 border-b-black font-bold md:text-xs uppercase md:px-6 px-4 md:py-2 py-1 text-center inline-flex items-center justify-center gap-2 duration-300 md:hover:bg-black md:hover:text-theme1 md:hover:border-theme1 shadow-md shadow-black/40"
              >
                Sign Up <LiaSignInAltSolid className="size-5 md:block hidden" />
              </Link>
              <Link
                to="/signup"
                className="text-black text-[0.65rem] bg-theme1 border-2 border-theme1 md:h-[40px] h-[32px] border-b-black font-bold md:text-xs uppercase md:px-6 px-3 md:py-2 py-2 text-center inline-flex items-center justify-center gap-2 duration-300 md:hover:bg-black md:hover:text-theme1 md:hover:border-theme1 shadow-md shadow-black/40"
              >
                Become A Seller
