...
const LogoutDialogue = ({logout, setLogout}) => {
    return (
        <>
                    ...
                    >
                        ...
                        <div class="relative bg-white rounded-lg shadow">
                            ...
                            <div class="p-4 md:p-5 text-center">
                                ...
                                <button onClick={()=>{setLogout(false)}} type="button" class="border-2 grow border-b-black  font-bold text-xs uppercase md:px-6 px-4 md:py-2 py-1 text-center inline-flex items-center justify-center gap-2 duration-300 md:hover:bg-black text-black border-theme1 hover:border-b-theme1 shadow-md hover:text-theme1 shadow-black/40 ml-3">No, cancel</button>
                            </div>
                        </div>
                        </Dialog.Panel>
                    </Transition.Child>
