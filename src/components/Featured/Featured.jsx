                ...
                <div className="max-w-screen-xl mx-auto p-4 z-[1] relative">
                    <div className="flex items-center pb-8">
                        ...
                        <div className="grow">
                            ...
                            <div className="featurednext sm:flex hidden  border hover:bg-black transition hover:text-white hover:border   items-center justify-center rounded-lg w-9 h-9 absolute z-10 end-[18px] top-[18px] border-black">
                                ...
                                <div className="flex flex-wrap w-full h-full items-stretch">
                                    <div className="w-full flex flex-wrap relative items-stretch gap-8 border-b lg:py-8 p-5 border border-gray-400 shadow-lg bg-white/60 rounded-xl shadow-theme1/20">
                                        ...
                                        <div className="w-full shrink-0 flex">
                                            ...
                                            <div className="w-full">
                                                <Link className="text-black w-full bg-theme1 border-2 border-theme1 border-b-black font-bold text-xs uppercase px-4 md:py-2 py-1 text-center inline-flex items-center justify-center gap-2 duration-300 md:hover:bg-black md:hover:text-theme1 md:hover:border-theme1 shadow-md shadow-black/40">Chat with Seller <RiChat1Line className='size-5' /></Link>
                                            </div>
