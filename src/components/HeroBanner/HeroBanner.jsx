...
import bannerMob from '../../asstes/img/bannerSecond.png'
      ...
      <div className="bg-white">
        <div className="w-full overflow-hidden">
          <div className="grid grid-cols-1 relative">
              ...
              <div className="prev border md:flex hidden flex items-center justify-center rounded-lg hover:bg-black hover:text-white w-9 h-9 absolute top-[50%] -translate-y-1/2 z-10 left-[20px] border-black">
                <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 512 512" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg"><path d="M217.9 256L345 129c9.4-9.4 9.4-24.6 0-33.9-9.4-9.4-24.6-9.3-34 0L167 239c-9.1 9.1-9.3 23.7-.7 33.1L310.9 417c4.7 4.7 10.9 7 17 7s12.3-2.3 17-7c9.4-9.4 9.4-24.6 0-33.9L217.9 256z"></path></svg>
              </div>
              <div className="next border md:flex hidden flex items-center justify-center rounded-lg hover:bg-black hover:text-white w-9 h-9 absolute top-[50%] -translate-y-1/2 z-10 end-[20px] border-black">
