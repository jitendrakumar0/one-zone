                ...
                <div className="max-w-screen-xl mx-auto p-4">
                    <div className="w-full bg-white rounded-xl shadow-xl md:px-10 md:py-6 p-5">
                        ...
                        <div className="profile-wrapper w-full md:mt-8 mt-0 flex md:space-x-10">
                            <div className="w-[236px] min-h-[600px] border-r border-[rgba(0, 0, 0, 0.1)] max-md:hidden rtl:ml-5">
                                <AllSideMenu />
                            </div>
                                        ...
                                        <div className="flex h-full items-stretch">
                                            <div className="w-full flex flex-wrap relative items-stretch gap-8 border-b lg:py-8 p-5 border border-gray-200 shadow-lg bg-white rounded-xl shadow-theme1/20">
                                                <div className=" w-full lg:relative shrink-0 grid items-center justify-center">
                                                    <button className="size-8 rounded-full bg-white shadow-md md:hover:bg-white duration-300 text-black backdrop-blur-2xl p-2 flex items-center justify-center absolute top-3 right-3">
                                                ...
                                                <div className="w-full">
                                                    ...
                                                    <ul className="w-full list-disc ml-5 pt-4 md:text-sm text-xs text-black/80 rtl:mr-5 ">
                                                ...
                                                <div className="w-full shrink-0 flex">
                                                    ...
                                                    <div className="shrink-0">
                                                        <Link className="text-black w-full bg-theme1 border-2 border-theme1 border-b-black md:hover:border-b-black !rounded-full font-bold text-xs uppercase lg:px-3 xl:px-6 px-4 md:py-2 py-1 text-center inline-flex items-center justify-center gap-2 duration-300 md:hover:bg-black md:hover:text-theme1 md:hover:border-theme1 shadow-md shadow-black/40">Chat with Seller <RiChat1Line className='size-5' /></Link>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
