...
const Chat = () => {
    ...
    return (
        <>
            <Header/>
            <div className= 'chatParent  max-w-screen-xl flex justify-between mx-auto p-4 pt-8 h-[calc(100vh-70px)] md:h-[calc(100vh-174px)] overflow-hidden '>
                        ...
                        <div className='w-full flex flex-col h-full overflow-hidden'>
                            ...
                            <div className="bodyyy overflow-y-auto flex-grow h-full">
                                <div className="tab-content">
                                    {activeTab === 'tab1' && 
                                        <>
                                            <div onClick={handleClick} className='flex mt-4 bg-gray-200 px-5 py-6 border border-b-slate-400'>
                                            ...
                                            <div onClick={handleClick} className='flex my-4 bg-gray-200 px-5 py-6 border border-b-slate-400'>
                                                <div className='col-auto'>
                                                    <div className="user  rounded-md relative cursor-pointer">
                                                        <img className='w-14 h-14 rounded-md' src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR6FBe113B4a9BYPo2IMGrtgym2plpPyfOfiA&usqp=CAU" alt="" />
                                                        <img className='absolute size-8 rounded-full top-8 -right-4 border border-white' src="https://i.pravatar.cc/150?u=a042581f4e29026704d" alt="" />
                        ...
                        <div className='bodyy h-full flex-grow overflow-y-auto flex flex-col-reverse'>
                            <div className='w-full bg-gray-200 py-5   '>
                                ...
                                <div className='w-full flex justify-end'>
                                    ...
                                    <img class="w-8 h-8 rounded-full" src="https://i.pravatar.cc/150?u=a042581f4e29026704d" alt="Bonnie Green"/>
                                ...
                                <div className='w-full flex justify-end'>
                                    <div class="flex items-start gap-2.5 mx-5 mt-5">
                                    <img class="w-8 h-8 rounded-full" src="https://i.pravatar.cc/150?u=a042581f4e29026704d" alt="Jese"/>
                            ...
                            <div className="border-t-2 border-gray-200 px-4 py-4 mb-2 sm:mb-0 bg-white">
                                <div className="relative flex">
                                    ...
                                    <div className="absolute right-0 items-center inset-y-0 sm:flex">
                                        <button
                                            type="button"
                                            className="inline-flex items-center justify-center rounded-full h-10 w-10 transition duration-500 ease-in-out text-gray-500 hover:bg-gray-300 focus:outline-none lg:block hidden"
                                        >
                                            <svg
                                                xmlns="http://www.w3.org/2000/svg"
                                                fill="none"
