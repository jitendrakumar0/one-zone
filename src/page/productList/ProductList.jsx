...
function classNames(...classes) {
    ...
    return (
        ...
        <div className="flex">
            <div className="hidden sm:block sm:w-1/4 lg:w-1/5 bg-white py-5 md:py-10 px-5 lg:absolute lg:h-full lg:z-50 lg:w-[350px]">
            <div className="md:px-6 flex flex-col gap-2 sticky top-[155px]">
                ...
                {({ open }) => (
                    ...
                    <>
                        ...
                        <div className="checckBox flex flex-col px-5">
                ...
                {/* <Disclosure>
                    ...
                    <Disclosure.Panel className="text-gray-500">
                    <div className="checckBox flex flex-col ">
                        <div className="flex items-center gap-2">
                        <input
                            type="checkbox"
                            className="accent-[#374151]"
            ...
            <div className="w-full sm:w-3/4 lg:w-4/5 py-5 md:py-10 overflow-y-auto text-center">
                <div className="list-none inline-flex gap-4 rounded-full bg-white p-3">
                    <button className={`px-8 py-3  rounded-full text-center font-semibold  ${activeTab === 'tab1' ? 'bg-gray-700 text-gray-100' : 'bg-gray-100 text-gray-500'}`}
                        onClick={() => handleTabClick('tab1')}>
                        Laptop
                    </button>
                    <button className={`px-8 py-3 rounded-full text-center font-semibold  ${activeTab === 'tab2' ? 'bg-gray-700 text-gray-100' : 'bg-gray-100 text-gray-500'}`}
                        onClick={() => handleTabClick('tab2')}>
                        PC
                    </button>
                    <button className={`px-8 py-3  rounded-full text-center font-semibold  ${activeTab === 'tab3' ? 'bg-gray-700 text-gray-100' : 'bg-gray-100 text-gray-500'}`}
                        ...
                        <>
                            <div className="px-5">
                                ...
                                <div className>
                                    ...
                                    <button className="h-4 w-4"><svg stroke="currentColor" fill="none" stroke-width="2" viewBox="0 0 24 24" stroke-linecap="round" stroke-linejoin="round" class="h-full w-full" xmlns="http://www.w3.org/2000/svg"><polygon points="22 3 2 3 10 12.46 10 19 14 21 14 12.46 22 3"></polygon></svg></button>
                        ...
                        <>
                            <div className="px-5">
                                ...
                                <div className="w-full md:w-1/2 lg:w-1/3 p-4">
                                    ...
                                    <div class="bg-white p-3 flex justify-start items-start flex-col">
                                        <div class="text-lg font-medium mb-2">Apple 14 pro</div>
                                        <div className="">
                                        <span className="bg-[#09757A] rounded text-white px-3 py-1 mr-2">
                                            SSD:2GB
                                        </span>
                                        <span className="bg-[#09757A] rounded text-white px-3 py-1 mr-2">
                                            ROM:2GB
                                        </span>
                                        <span className="bg-[#09757A] rounded text-white px-3 py-1">
                                            Intel
                                        </span>
                                        {/* <span className='bg-[#09757A] rounded-tl-lg rounded-br-lg text-white px-3 py-1'>Intel</span> */}
                                        </div>
