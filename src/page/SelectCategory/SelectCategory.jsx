        ...
        <Header/>
            <div className="max-w-screen-md  mx-auto my-5 px-4">
                ...
                <div className="border border-gray-400 p-4 rounded-lg mt-8">
                    <div className='text-lg rounded-lg p-2'>CHOOSE A CATEGORY</div>
                    <Disclosure>
                        <Disclosure.Button className="w-full">
                            <div className='flex items-center w-full bg-white shadow p-4 mt-4 rounded-lg border-b-2 border-black'>
                                ...
                                <div className="grow text-start">
                                    <div className='text-base ms-5'>Windows</div>
                                </div>
                                <div className="flex-none">
                    ...
                    <Disclosure>
                        <Disclosure.Button className="w-full">
                            <div className='flex items-center w-full bg-white shadow p-4 mt-4 rounded-lg border-b-2 border-black'>
                                ...
                                <div className="grow text-start">
                                    <div className='text-base ms-5'>Mac</div>
                                </div>
                                <div className="flex-none">
                                    <BsArrowDownSquareFill className='sm:size-8 size-6'/>
                                </div>
                    ...
                    <Disclosure>
                        <Disclosure.Button className="w-full">
                            <div className='flex items-center w-full bg-white shadow p-4 mt-4 rounded-lg border-b-2 border-black'>
                                ...
                                <div className="grow text-start">
                                    <div className='text-base ms-5'>Chromebook</div>
                                </div>
                                <div className="flex-none">
                                    <BsArrowDownSquareFill className='sm:size-8 size-6'/>
                                </div>
                    ...
                    <Disclosure>
                        <Disclosure.Button className="w-full">
                            <div className='flex items-center w-full bg-white shadow p-4 mt-4 rounded-lg border-b-2 border-black'>
                                ...
                                <div className="grow text-start">
                                    <div className='text-base ms-5'>Mobile</div>
                                </div>
                                <div className="flex-none">
                                    <BsArrowDownSquareFill className='sm:size-8 size-6'/>
                                </div>
                    ...
                    <Disclosure>
                        <Disclosure.Button className="w-full">
                            <div className='flex items-center w-full bg-white shadow p-4 mt-4 rounded-lg border-b-2 border-black'>
                                ...
                                <div className="grow text-start">
                                    <div className='text-base ms-5'>Mob & Tab</div>
                                </div>
                                <div className="flex-none">
                                    <BsArrowDownSquareFill className='sm:size-8 size-6'/>
                                </div>
                    ...
                    <Disclosure>
                        <Disclosure.Button className="w-full">
                            <div className='flex items-center w-full bg-white shadow p-4 mt-4 rounded-lg border-b-2 border-black'>
                                ...
                                <div className="grow text-start">
                                    <div className='text-base ms-5'>Photocopy Machine</div>
                                </div>
                                <div className="flex-none">
                                    <BsArrowDownSquareFill className='sm:size-8 size-6'/>
                                </div>
                    ...
                    <Disclosure>
                        <Disclosure.Button className="w-full">
                            <div className='flex items-center w-full bg-white shadow p-4 mt-4 rounded-lg border-b-2 border-black'>
                                ...
                                <div className="grow text-start">
                                    <div className='text-base ms-5'>Servers</div>
                                </div>
                                <div className="flex-none">
                                    <BsArrowDownSquareFill className='sm:size-8 size-6'/>
                                </div>
