            ...
            <div className="max-w-screen-sm mx-auto my-5 border rounded-lg p-4">
                <div>
                    <div className="bg-theme1 shadow-md shadow-black/20 w-full h-40 rounded-lg flex items-center justify-center flex-col">
                        ...
                        <div className='text-xl font-semibold text-black px-4 text-balance text-center'>Grow your business with feature post</div>
                    </div>
                </div>
                <div className='py-6 border-b'>
                    <div className='text-base text-black font-semibold'>FEATURE AD</div>
                ...
                <div className="pt-6">
                    <div className='text-sm text-black font-semibold '>Featured ads for 30 days</div>
                    ...
                    <div className="grid grid-cols-1 gap-5 py-5">
                        <label htmlFor='ad1' className="w-full card p-4 flex justify-between items-center bg-white has-[:checked]:border-yellow-600 border-2  border-yellow-600 has-[:checked]:bg-gradient-to-r from-yellow-50 to-yellow-200  rounded-lg shadow sm:p-4 group/ads">
                            ...
                            <div className="flex items-end text-gray-900 flex-col">
                                <span className='flex items-baseline gap-1'>
                                    ...
                                    <span className="text-lg sm:text-2xl font-medium tracking-tight">7,080</span>
                                </span>
                        ...
                        <label htmlFor='ad2' className="w-full p-4 flex justify-between items-center bg-white has-[:checked]:border-teal-500 border-2 border-teal-500 has-[:checked]:bg-gradient-to-r from-teal-50 to-green-200 rounded-lg shadow sm:p-4 group/ads ">
                            ...
                            <div className="flex items-end text-gray-900 flex-col">
                                <span className='flex items-baseline gap-1'>
                                    <span className="text-xl font-semibold">$</span>
                                    <span className="text-lg sm:text-2xl font-medium tracking-tight">4,720</span>
                                </span>
                        ...
                        <label htmlFor='ad3' className="w-full p-4 flex justify-between items-center bg-white has-[:checked]:border-gray-400 border-2 has-[:checked]:bg-gradient-to-r from-gray-50 to-gray-200 border-gray-400  rounded-lg shadow sm:p-4 group/ads">
                            ...
                            <div className="flex items-end text-gray-900 flex-col">
                                <span className='flex items-baseline gap-1'>
                                    <span className="text-xl font-semibold">$</span>
                                    <span className="text-lg sm:text-2xl font-medium tracking-tight">2,360</span>
                                </span>
                            </div>
                        </label>
                    </div>
